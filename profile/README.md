<picture>
  <source media="(prefers-color-scheme: dark)" srcset="./images/openchoreo-horizontal-white.png">
  <img alt="OpenChoreo Logo" src="./images/openchoreo-horizontal-color.png" width="300">
</picture>

# A complete, open-source developer platform for Kubernetes

OpenChoreo helps platform builders deliver self-service developer platforms without stitching together complex toolchains from scratch. It brings together development and architecture abstractions as APIs, a Backstage-powered developer portal, application CI/CD, GitOps, RBAC, observability and more to deliver a cohesive developer platform.

OpenChoreo is designed to be modular. You can use it as-is, or tailor it to fit your own internal developer platform vision.
